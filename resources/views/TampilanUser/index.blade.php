                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            ...
                            <div class="text-uppercase">Desainer and Photografer</div>
                        </div>
                        <div class="fs-3 fw-light text-muted">Hallo nama saya Zulfikar</div>
                        <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Menerima jasa Desain dan Photografer</span></h1>
